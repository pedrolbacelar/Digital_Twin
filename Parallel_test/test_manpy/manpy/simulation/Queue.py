...
class Queue(CoreObject):
    ...
    def __init__(
        ...
        **kw
        ...
        self.level = level
        self.level_history = []
        self.priority_giver = priority_giver
    ...
    def __repr__(self):
        return f"Queue({self.id!r}, {self.name!r}, capacity={self.capacity}, gatherWIPStat={bool(self.gatherWipStat)}, priority_giver={bool(self.priority_giver)})"
