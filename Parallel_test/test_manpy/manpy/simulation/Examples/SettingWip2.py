...
E = Exit("E1", "Exit")
P1 = Part("P1", "Part1", currentStation=Q)      # We have a part that is in the queue
P2 = Part("P2", "Part2", currentStation=M)      # We have a part that is being processed in the machine
