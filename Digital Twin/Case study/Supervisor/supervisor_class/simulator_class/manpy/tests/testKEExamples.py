...
class KnowledgeExtractionExamples(TestCase):
    ...
    def testTwoParallelStations(self):
        from manpy.KnowledgeExtraction.KEtool_examples.TwoParallelStations.TwoParallelStations_example import (
            main,
        )
    ...
    def testTwoServers(self):
        from manpy.KnowledgeExtraction.KEtool_examples.TwoServers.TwoServers_example import (
            main,
        )
    ...
    def testAssembleDismantle(self):
        from manpy.KnowledgeExtraction.KEtool_examples.AssembleDismantle.AssembleDismantle_example import (
            main,
        )
    ...
    def testConveyerLine(self):
        from manpy.KnowledgeExtraction.KEtool_examples.ConveyerLine.KEtool_MainScript import (
            main,
        )
    ...
    def testConfidenceIntervals(self):
        from manpy.KnowledgeExtraction.KEtool_examples.ConfidenceIntervals.ConfidenceIntervals_example import (
            main,
        )
    ...
    def testSingleServer(self):
        from manpy.KnowledgeExtraction.KEtoolSimul8_examples.SingleServer.SingleServer import (
            main,
        )
        ...
        for objects in root.findall("./SimulationObjects/SimulationObject"):
            if (
                objects.attrib["Type"] == "Work Entry Point"
                and objects.attrib["Name"] == "Source"
            ):
            ...
            if (
                objects.attrib["Type"] == "Work Center"
                and objects.attrib["Name"] == "Activity 1"
            ):
    ...
    def testTopology1(self):
        from manpy.KnowledgeExtraction.KEtoolSimul8_examples.Topology1.Topology1 import (
            main,
        )
        ...
        result = main(
            test=1, workbook=workbook, csvFile=csvFile, simul8XMLFile=simul8XMLFile
        )
        root = result.getroot()
        for objects in root.findall("./SimulationObjects/SimulationObject"):
            if (
...
#         from manpy.KnowledgeExtraction.KEtool_examples.ParallelStations_withfailures.ParallelStations_example import main
#         filepath=os.path.join(project_path, "manpy", "KnowledgeExtraction", "KEtool_examples",
...
#         from manpy.KnowledgeExtraction.KEtoolSimul8_examples.ParallelStationsFailures.ParallelStationsFailures import main
#         filepath=os.path.join(project_path, "manpy", "KnowledgeExtraction", "KEtoolSimul8_examples",
