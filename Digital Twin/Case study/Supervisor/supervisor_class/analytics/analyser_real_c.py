...
class analyser_real():
    def __init__(self,interface_DB=None,n_pallet=None,t_horizon=None):
    ...
    def run(self):
        condition_analyser=True
        while condition_analyser ==True:
            ...
            print("number_of_pallets assumed = "+str(self.n_pallet))
           ...
           #compute processing_time 
            ...
            for i in range (min(id_count),max(id_count)+1):
              ...
              #write System_time_New generated
            ...
            #compute inter_dep_timereal
            inter_dep_timereal=interdeparture_time_real(data) 
            #generate inter_dep_timereal new
